...
Character artwork is presentation data, not factual character data. Keep image paths, localized alt text, provenance, and usage status in the artwork manifest. The manifest's usage status is a project policy and never transfers ownership of third-party artwork.
