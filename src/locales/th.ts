export const th = {
  brand: "Teyvat Personalities", navQuiz: "แบบทดสอบ", navCharacters: "ตัวละคร", navResult: "ตัวอย่างผลลัพธ์", language: "EN", skipContent: "ข้ามไปยังเนื้อหาหลัก",
  eyebrow: "ค้นหาเสียงสะท้อนของคุณใน Teyvat", heroTitle: "ตัวละครคนไหนที่มีบุคลิกเหมือนคุณมากที่สุด?", heroBody: "ตอบคำถามสถานการณ์ 24 ข้อ เพื่อค้นหา Character Match และ Vision Affinity ที่สะท้อนวิธีคิดของคุณ",
  start: "เริ่มทำแบบทดสอบ", resume: "ทำแบบทดสอบต่อ", preview: "ดูตัวอย่างผลลัพธ์", meta: "ประมาณ 3–5 นาที · ไม่มีคำตอบที่ถูกหรือผิด",
  featureCharacter: "Character Match", featureCharacterBody: "เปรียบเทียบโปรไฟล์บุคลิกของคุณกับตัวละครที่คัดสรรมาอย่างหลากหลาย",
  featureVision: "Vision Affinity", featureVisionBody: "ค้นหาธาตุที่สอดคล้องกับแรงขับและวิธีมองโลกของคุณ แยกจากผลตัวละคร",
  featureShare: "ผลลัพธ์ที่เล่าเรื่องได้", featureShareBody: "รับคำอธิบาย Trait สำคัญและการ์ดผลลัพธ์ที่เตรียมไว้สำหรับการแชร์",
  question: "คำถาม", back: "ย้อนกลับ", next: "ถัดไป", finish: "ดูผลลัพธ์", selectHint: "เลือกคำตอบที่ใกล้กับตัวคุณที่สุด",
